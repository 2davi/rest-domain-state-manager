 ...
 * @type {string}
 */
export const DEBUG_CHANNEL_NAME: string;
/**
 ...
 * @enum {string}
 */
export const MSG_TYPE: Readonly<{
 ...
 * @type {string}
 */
export const DEBUG_POPUP_NAME: string;
/**
 * DEBUG_POPUP_FEATURES : 팝업 창 크기 및 위치 옵션
 * @type {string}
 */
export const DEBUG_POPUP_FEATURES: string;
