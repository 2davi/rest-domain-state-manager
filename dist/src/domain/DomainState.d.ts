...
export class DomainState {
    ...
    _getChangeLog: () => import("../core/api-proxy.js").ChangeLogEntry[];
    /** @type {() => object} */
    _getTarget: () => object;
    /** @type {() => void} */
    ...
    _restoreTarget: (data: object) => void;
    /** @type {(entries: import('../core/api-proxy.js').ChangeLogEntry[]) => void} */
    _restoreChangeLog: (entries: import("../core/api-proxy.js").ChangeLogEntry[]) => void;
    /** @type {(fields: Set<string>) => void} */
    _restoreDirtyFields: (fields: Set<string>) => void;
    /** @type {import('../network/api-handler.js').ApiHandler|null} */
    _handler: import("../network/api-handler.js").ApiHandler | null;
     ...
     */
    _assertHandler(method: string): import("../network/api-handler.js").ApiHandler;
    /**
...
export type DomainStateOptions = {
     ...
     */
    handler?: import("../network/api-handler.js").ApiHandler | null | undefined;
    /**
 ...
 * 외부에서는 `proxy`만 접근하고, 나머지는 `DomainState` 내부에서만 사용한다.
 */
export type ProxyWrapper = import("../core/api-proxy.js").ProxyWrapper;
