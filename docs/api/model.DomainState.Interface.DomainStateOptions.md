...
> `optional` **handler?**: [`ApiHandler`](handler.api-handler.Class.ApiHandler.md) \| `null`
...
> `optional` **transformers?**: [`TransformerMap`](model.DomainState.TypeAlias.TransformerMap.md)
...
> `optional` **urlConfig?**: [`NormalizedUrlConfig`](model.DomainState.Interface.NormalizedUrlConfig.md) \| `null`
...
> `optional` **validators?**: [`ValidatorMap`](model.DomainState.TypeAlias.ValidatorMap.md)
