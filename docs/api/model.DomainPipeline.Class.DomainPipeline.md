...
[`ResourceMap`](model.DomainPipeline.TypeAlias.ResourceMap.md)

키: 리소스 식별자, 값: `Promise<DomainState>`

##### options?

[`PipelineOptions`](model.DomainPipeline.Interface.PipelineOptions.md) = `{}`
...
> **\_queue**: [`QueueEntry`](model.DomainPipeline.Interface.QueueEntry.md)[]
...
> **\_resourceMap**: [`ResourceMap`](model.DomainPipeline.TypeAlias.ResourceMap.md)
...
[`AfterHandler`](model.DomainPipeline.TypeAlias.AfterHandler.md)
...
> **run**(): `Promise`\<[`PipelineResult`](model.DomainPipeline.TypeAlias.PipelineResult.md)\>
...
`Promise`\<[`PipelineResult`](model.DomainPipeline.TypeAlias.PipelineResult.md)\>
