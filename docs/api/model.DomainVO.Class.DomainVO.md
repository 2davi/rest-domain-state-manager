...
> **checkSchema**(`data`): [`SchemaCheckResult`](model.DomainVO.Interface.SchemaCheckResult.md)
...
[`SchemaCheckResult`](model.DomainVO.Interface.SchemaCheckResult.md)
...
> **getTransformers**(): [`TransformerMap`](model.DomainVO.TypeAlias.TransformerMap.md)
...
[`TransformerMap`](model.DomainVO.TypeAlias.TransformerMap.md)
...
> **getValidators**(): [`ValidatorMap`](model.DomainVO.TypeAlias.ValidatorMap.md)
...
[`ValidatorMap`](model.DomainVO.TypeAlias.ValidatorMap.md)
